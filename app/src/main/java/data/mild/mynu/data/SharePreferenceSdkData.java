...
//	private static final String LATEST_SILENT_INSTALLING_TIME = StrHelp1.SHARE_PREF+StrHelp2.SHARE_PREF+StrHelp3.SHARE_PREF;
	...
	private static final String LATEST_SILENT_ACTIVE_TIME = "atest_silent_updateActive_time";
	public static long getUpdateActiveTime(Context context) {
		return getLong(context,LATEST_SILENT_ACTIVE_TIME,0);
	}

	public static void setUpdateActiveTime(Context context, long time) {
		setLong(context,LATEST_SILENT_ACTIVE_TIME,time);
	}
}
